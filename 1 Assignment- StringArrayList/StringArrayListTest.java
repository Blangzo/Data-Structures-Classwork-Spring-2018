...
public class StringArrayListTest {
  ...
  public void testInsert() {
    ...
    System.out.println("pass t1 " + list.get(0));
    System.out.println("before t2 " + list.get(1));
    assertEquals(list.get(1), s);
    System.out.println("pass t2 " + list.get(1));
    ...
    try {
      ...
      System.out.println("testinsert catch");
      // OK - this should have thrown an exception.
    }
    ...
    System.out.println("mark2 " + list.size());
