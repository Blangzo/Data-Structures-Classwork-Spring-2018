...
public class StackTest {
  ...
  public void testPushPop() {
     System.out.println("testPushPop start");
    ...
    System.out.println("first pushpop set passed");
    assertTrue(as.isEmpty());
    assertTrue(ls.isEmpty());
   System.out.println("second pushpop set passed");
    try {
      as.pop();
    ...
    System.out.println("third pushpop set passed");
    try {
      ls.pop();
    ...
    System.out.println("testPushPop end success");
  }

  @Test
  public void testPeek() {
     System.out.println("testPeek start");
    Stack<Double> as = new ArrayStack<Double>();
    Stack<Double> ls = new LinkedStack<Double>();
    ...
    System.out.println("first peek set passed");

    // test a second time to ensure no mutation
    assertEquals(last, as.peek());
    assertEquals(last, ls.peek());
    System.out.println("testPeek end success");
  }

  @Test
  public void testPerformance() {
     System.out.println("testPerformance start");
    Stack<Double> as = new ArrayStack<Double>();
    Stack<Double> ls = new LinkedStack<Double>();
    ...
    System.out.println("testPerformance end success");
  }
